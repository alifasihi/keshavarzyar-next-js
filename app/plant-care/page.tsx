...
export default function PlantCarePage() {
  return (
    <div className="container py-8">
      <h1 className="text-3xl font-bold mb-8">راهنمای مراقبت از گیاهان</h1>

      <div className="grid md:grid-cols-2 gap-8 mb-12">
        <div className="space-y-4">
          <h2 className="text-2xl font-bold">گیاهان خود را سرزنده نگه دارید</h2>
        ...
        <div className="relative h-[300px] rounded-xl overflow-hidden">
          <Image src="/placeholder.svg?height=300&width=600" alt="مراقبت از گیاهان" fill className="object-cover" />
        </div>
      </div>

      <div className="grid md:grid-cols-2 gap-8">
        {careGuides.map((guide) => (
          <Link key={guide.id} href={`/plant-care/${guide.id}`}>
      ...
      <div className="mt-12 bg-[#171f12] rounded-xl p-8">
        <h2 className="text-2xl font-bold mb-4">سوالی در مورد مراقبت از گیاهان دارید؟</h2>
